...
const Information = () => {
  return (
    <div>
      <div className="flex flex-row md:flex-row items-center bg-white shadow-top-bottom">
        ...
        <div className="w-full md:w-7/12 px-4">
          <p className="text-md md:text-4xl leading-tight text-center my-8 font-hubbali">
